...
describe("reducePrototypeChainTest", function () {
    it("reduces a whole objects prototype chain", function () {
        ...
        var expectedResult = function expectedResult() {
            ...
            if (NODE_MAJOR_VERSION < 10) return ["constructor", "write", "cork", "uncork", "setDefaultEncoding", "_write", "_writev", "end", "destroyed", "_destroy", "constructor", "destroyed", "destroy", "_undestroy", "_destroy", "push", "unshift", "isPaused", "setEncoding", "read", "_read", "pipe", "unpipe", "on", "addListener", "resume", "pause", "wrap", "constructor", "pipe", "constructor", "domain", "_events", "_maxListeners", "setMaxListeners", "getMaxListeners", "emit", "addListener", "on", "prependListener", "once", "prependOnceListener", "removeListener", "removeAllListeners", "listeners", "listenerCount", "eventNames"];

            return ["constructor", "write", "cork", "uncork", "setDefaultEncoding", "_write", "_writev", "end", "writableHighWaterMark", "writableBuffer", "writableLength", "destroyed", "constructor", "destroyed", "destroy", "_undestroy", "_destroy", "push", "unshift", "isPaused", "setEncoding", "read", "_read", "pipe", "unpipe", "on", "addListener", "removeListener", "removeAllListeners", "resume", "pause", "wrap", "readableHighWaterMark", "readableBuffer", "readableFlowing", "readableLength", "constructor", "pipe", "constructor", "_events", "_eventsCount", "_maxListeners", "setMaxListeners", "getMaxListeners", "emit", "addListener", "on", "prependListener", "once", "prependOnceListener", "removeListener", "off", "removeAllListeners", "listeners", "rawListeners", "listenerCount", "eventNames"];
        };
    ...
    it("reduces a a prototype chain until a specific constructor occurs in the chain", function () {
        ...
        var expectedResult = function expectedResult() {
            ...
            if (NODE_MAJOR_VERSION < 10) return ["constructor", "write", "cork", "uncork", "setDefaultEncoding", "_write", "_writev", "end", "destroyed", "_destroy", "constructor", "destroyed", "destroy", "_undestroy", "_destroy", "push", "unshift", "isPaused", "setEncoding", "read", "_read", "pipe", "unpipe", "on", "addListener", "resume", "pause", "wrap", "constructor", "pipe"];

            return ["constructor", "write", "cork", "uncork", "setDefaultEncoding", "_write", "_writev", "end", "writableHighWaterMark", "writableBuffer", "writableLength", "destroyed", "constructor", "destroyed", "destroy", "_undestroy", "_destroy", "push", "unshift", "isPaused", "setEncoding", "read", "_read", "pipe", "unpipe", "on", "addListener", "removeListener", "removeAllListeners", "resume", "pause", "wrap", "readableHighWaterMark", "readableBuffer", "readableFlowing", "readableLength", "constructor", "pipe"];
        };
    ...
    it("tries to stop at a prototype not in the chain", function () {
        ...
        (0, _chai.expect)((0, _reducePrototypeChain.reducePrototypeChain)(Object.prototype, cb, [], constr)).to.eql([]);
    });
});
